...
public class List_Vet extends JFrame 
{
	...
	public List_Vet() 
	{
		...
		//////////////////////////////////////////////////////////////////////////
               ...
               frame2.setSize(800, 600);
	            ...
	            defaultTableModel.addColumn("idvet");
	            ...
	            try
	            {
	            	...
	            	Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/pet_clinic", "root", "123456.Abc");
	                ...
	                {
	                    String ID = resultSet.getString("idvet");
	                    ...
	                    String slr = resultSet.getString("Salary");
	                    
	                        defaultTableModel.addRow(new Object[]{ID, name, sur , a,gen, pho,addr,slr});
	            ...
	            JFrame frame3 = new JFrame();
	               ...
	               frame3.setSize(800, 600);
		            ...
		            try
		            {
		            	...
		            	Connection connectionn = DriverManager.getConnection("jdbc:mysql://localhost:3306/pet_clinic", "root", "root");
